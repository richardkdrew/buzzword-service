...
.PARAMETER Clean
Removes the image buzzword-service and kills all containers based on that image.
...
Build a Docker image named buzzword-service
#>
...
$imageName="buzzword-service"
$projectName="buzzwordservice"
$serviceName="buzzword-service"
